/* ==============================================================================
   jQuery UI Touch Punch Fix
   Maps touch events to mouse events so the Slider works on Mobile/Tablet
   ============================================================================== */
(function(b){b.support.touch="ontouchend"in document;if(!b.support.touch){return}var c=b.ui.mouse.prototype,e=c._mouseInit,a=c._mouseDestroy,d;function f(g,h){if(g.originalEvent.touches.length>1){return}g.preventDefault();var i=g.originalEvent.changedTouches[0],j=document.createEvent("MouseEvents");j.initMouseEvent(h,true,true,window,1,i.screenX,i.screenY,i.clientX,i.clientY,false,false,false,false,0,null);g.target.dispatchEvent(j)}c._touchStart=function(g){var h=this;if(d||!h._mouseCapture(g.originalEvent.changedTouches[0])){return}d=true;h._touchMoved=false;f(g,"mousedown")};c._touchMove=function(g){if(!d){return}this._touchMoved=true;f(g,"mousemove")};c._touchEnd=function(g){if(!d){return}f(g,"mouseup");f(g,"mouseout");if(!this._touchMoved){f(g,"click")}d=false};c._mouseInit=function(){var g=this;g.element.bind({touchstart:b.proxy(g,"_touchStart"),touchmove:b.proxy(g,"_touchMove"),touchend:b.proxy(g,"_touchEnd")});e.call(g)};c._mouseDestroy=function(){var g=this;g.element.unbind({touchstart:b.proxy(g,"_touchStart"),touchmove:b.proxy(g,"_touchMove"),touchend:b.proxy(g,"_touchEnd")});a.call(g)}})(jQuery);
...
//	heightEntry.size = 4;
	...
	sizeButton.onclick = animationManager.changeSize.bind(animationManager) ;
        ...
        // Move Controls removed - replaced with pseudocode section
