...
function Line(n1, n2, color, cv, d, weight, anchorIndex)
{
	...
	{		
		...
		context.font         = '14px sans-serif';  // Increased from 12px to 14px for better readability
	   ...
	   this.draw = function(ctx)
	   {
		   ...
		   ctx.globalAlpha = this.alpha;
			...
			if (this.highlighted)
				this.drawArrow(this.highlightDiff, "#00ff88", ctx);
			this.drawArrow(2, this.edgeColor, ctx);
	   }
